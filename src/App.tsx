...
createEffect(() => {
  ...
  return (
    <div class={styles.main} style={{width: '100%', height: '100%' }} >
      {/* <ViewerHeader state={state}  currentMimic={currentMimic!}/> */}
      <LiveMimic content={jsonFromMimFile} server='http://localhost:80' refreshMs={1000} style={{ height: '100%', "user-select": 'none' }} />
    </div>
  )
}
